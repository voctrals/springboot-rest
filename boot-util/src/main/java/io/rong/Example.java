...
public class Example {
	...
	public static void main(String[] args) throws Exception {
		String appKey = "4z3hlwrv4xyxt";//替换成您的appkey
		String appSecret = "Brh91otasCsS";//替换成匹配上面key的secret
		...
		CodeSuccessResult messagePublishPrivateResult = rongCloud.message.publishPrivate("userId1", messagePublishPrivateToUserId, messagePublishPrivateVoiceMessage, "thisisapush", "{\"pushData\":\"hello\"}", "4", 0, 0, 0);
		...
		CodeSuccessResult messagePublishGroupResult = rongCloud.message.publishGroup("userId", messagePublishGroupToGroupId, messagePublishGroupTxtMessage, "thisisapush", "{\"pushData\":\"hello\"}", 1, 1);
		...
		CodeSuccessResult messagePublishDiscussionResult = rongCloud.message.publishDiscussion("userId1", "discussionId1", messagePublishDiscussionTxtMessage, "thisisapush", "{\"pushData\":\"hello\"}", 1, 1);
		...
		// 验证码验证方法 
		CodeSuccessResult sMSVerifyCodeResult = rongCloud.sms.verifyCode("2312312", "2312312");
